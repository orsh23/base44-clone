...
export default function ProviderCodesPage() {
  ...
  return (
    <PageLayout>
      <PageHeader
        title={t("pageTitles.providerCodes", {
          defaultValue: "Provider Codes Management",
        })}
        description={t("providerCodes.pageDescription", {
          defaultValue: "Manage provider-specific codes and their mappings.",
        })}
        icon={Code}
      />
