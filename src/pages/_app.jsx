...
function MyApp({ Component, pageProps }) {
  ...
  if (!Component || typeof Component === "undefined") {
    console.error(
      "Error: Page component is undefined. This might be due to a routing or import issue.",
    );
    ...
    return (
      ...
      >
        ...
        <p>
          The page component could not be loaded. Please check the console for
          more details.
        </p>
        <p>
          This often indicates a problem with routing or a missing/incorrectly
        ...
        >
          <h3>Debug Info:</h3>
          <p>
            <strong>Component:</strong> {String(Component)}
          </p>
          <p>
            <strong>Component Type:</strong> {typeof Component}
          </p>
          <p>
          ...
          <p>
            <strong>PageProps:</strong> {JSON.stringify(pageProps, null, 2)}
          </p>
        </div>
      </div>
    );
